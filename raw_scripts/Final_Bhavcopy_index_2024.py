...
# Define the folders using E: drive instead of home directory
base_dir = Path("E:/")

# Define the folders using the E: drive
Bhavcopy_Download_Folder = base_dir / "Data_NSE_temporary"
index_file_download_folder = base_dir / "Data_NSE_Ind_temporary"
Final_Bhavcopy_Folder = base_dir / "Getbhavcopy_NSE"
